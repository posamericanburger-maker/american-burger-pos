    ...
    <header className="sticky top-0 z-50 bg-black/95 backdrop-blur border-b border-white/10">
      <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-8 text-sm font-bold text-white">
          ...
          <a href="#promos" className="hover:text-yellow-400 transition">
            Promos
          </a>
        ...
        <button className="bg-yellow-400 hover:bg-yellow-300 text-black px-5 py-3 rounded-xl font-black transition">
          🛒 Pedido
        </button>
      </div>
    </header>
