function Hero() {
  return (
    <section
      id="inicio"
      className="relative overflow-hidden bg-gradient-to-r from-red-700 via-red-600 to-yellow-500"
    >
      <div className="max-w-7xl mx-auto px-6 py-24 grid lg:grid-cols-2 gap-10 items-center">
        ...
        <div>
          ...
          <p className="text-white text-xl mt-8 max-w-lg leading-relaxed">
            ...
            Carne premium, papas crujientes,
            pollo crispy y sabor americano.
          </p>

          <div className="flex gap-4 mt-10">

            <button className="bg-yellow-400 hover:bg-yellow-300 text-black px-8 py-4 rounded-xl font-black transition">
              PEDIR AHORA
            </button>

            <button className="border-2 border-white text-white px-8 py-4 rounded-xl font-black hover:bg-white hover:text-black transition">
              VER MENÚ
            </button>
